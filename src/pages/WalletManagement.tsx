...
const WalletManagement = () => {
  ...
  const { data: walletsData, isLoading: isLoadingWallets } = useQuery({
    ...
    queryFn: () => financialsApi.getWallets({ limit: 20 }),
                      ...
                      <td className="py-3 px-4">
                        {txn.referenceId && (
                          <span
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              // Smart navigation: if description mentions booking/payment for booking, go to bookings
                              // Otherwise (topup, refund), go to payments
